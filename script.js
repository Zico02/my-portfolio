...
const translations = {
    en: {
        ...
        'experience.fekra.title': 'Business Process Analyst',
        'experience.fekra.company': 'FEKRA Group · International IT Consulting & Digital Transformation',
        'experience.fekra.meta': 'End-of-Studies Project (PFE) · Mar 2026 – Aug 2026 · Casablanca, Morocco',
        'experience.fekra.summary': 'End-of-studies project analyzing and optimizing the sales and supply chain processes of a multi-brand distribution client, delivering seven operational improvements on the IFS Cloud ERP platform.',
        'experience.fekra.b1': 'Analyzed sales and supply chain processes for a multi-brand distribution client; identified and prioritized 7 operational gaps',
        'experience.fekra.b2': 'Redesigned the inter-branch stock transfer process, replacing manual inventory balancing with a validated workflow that checks availability before transfer, reducing stock-out risk and fulfillment delays',
        'experience.fekra.b3': 'Structured the customer order-to-cash cycle into governed lifecycle stages with automated invoicing, improving order traceability for commercial teams',
        'experience.fekra.b4': 'Implemented data governance and role-based access controls across inventory master data, eliminating unrestricted modifications',
        'experience.fekra.b5': 'Extended the inventory data model with automated identifier generation and a dedicated management interface',
        'experience.fekra.b6': 'Applied a delivery continuity approach to modify live database structures with zero business disruption',
        'experience.fekra.b7': 'Delivered all 7 workstreams while preserving the standard ERP architecture, keeping the client\'s platform fully upgradable',
        'experience.yousfdent.title': 'Digital Transformation & Sales Growth Partner',
        'experience.yousfdent.meta': 'Apr 2026 – Present · Rabat-Salé-Kénitra, Morocco · Hybrid',
        'experience.yousfdent.b1': 'Digitalized YousfDent’s traditional dental product sales model by developing and managing its e-commerce platform, stock and order management system, lead generation process, and digital sales strategy.',
        'experience.yousfdent.b2': 'Contributed to scaling the business and increasing sales performance through a modern online acquisition and sales approach.',
        'experience.yousfdent.p1': 'YousfDent — brand identity',
        'experience.yousfdent.p2': 'YousfDent — homepage',
        'experience.yousfdent.p3': 'Category catalogue',
        'experience.yousfdent.p4': 'Product catalogue',
        ...
        'certifications.ifsadvanced.title': 'IFS Learning Achievement - Advanced Web Development Concepts (IFS Cloud)',
        'certifications.ifsadvanced.provider': 'IFS',
        'certifications.ifsadvanced.date': 'Issued Jun 2026',
        'certifications.ifsadvanced.mediaCaption': 'IFS Advanced Web Development Concepts certification',
        'certifications.ifsux.title': 'IFS Learning - User Experience Fundamentals (IFS Cloud)',
        'certifications.ifsux.provider': 'IFS',
        'certifications.ifsux.date': 'Issued Jun 2026',
        'certifications.ifsux.mediaCaption': 'IFS User Experience Fundamentals certification',
        ...
        'certifications.honoris.mediaCaption': 'Honoris 21st Century Soft Skills Certificate',
        ...
        'extracurricular.fitwinz.b1': 'Founded and developed Fitwinz, a Moroccan sportswear brand focused on performance, comfort, and a healthier approach to clothing.',
        'extracurricular.fitwinz.b2': 'Led brand development, including product design, branding strategy, and customer engagement, with a focus on natural materials such as wool, linen, and organic cotton.',
        'extracurricular.fitwinz.b3': 'Managed business operations including market research, pricing strategy, sales planning, and digital marketing initiatives.',
        'extracurricular.fitwinz.p1': 'Fitwinz Official Website',
        'extracurricular.fitwinz.p2': 'Compression Top 1 (linen-based fabric)',
        'extracurricular.fitwinz.p3': 'Compression Top 2 (linen-based fabric)',
        'extracurricular.fitwinz.p4': 'Oversized Fit 1 (wool-based fabric)',
        'extracurricular.fitwinz.p5': 'Compression shirt (Organic Cotton-based fabric)',
        'extracurricular.fitwinz.p7': 'Compression Top (linen-based fabric)',
        'extracurricular.fitwinz.p8': 'Oversized Fit (wool-based fabric)',
        'extracurricular.fitwinz.p6': 'Fitwinz Manufacturing & Product Collaboration',
    ...
    fr: {
        ...
        'experience.fekra.title': 'Analyste des Processus Métier',
        'experience.fekra.company': 'FEKRA Group · Conseil IT International & Transformation Digitale',
        'experience.fekra.meta': 'Projet de Fin d\'Études (PFE) · Mars 2026 – Août 2026 · Casablanca, Maroc',
        'experience.fekra.summary': 'Projet de fin d\'études portant sur l\'analyse et l\'optimisation des processus de vente et de chaîne d\'approvisionnement d\'un client de distribution multi-marques, avec la livraison de sept améliorations opérationnelles sur la plateforme ERP IFS Cloud.',
        'experience.fekra.b1': 'Analyse des processus de vente et de chaîne d\'approvisionnement d\'un client de distribution multi-marques ; identification et priorisation de 7 lacunes opérationnelles',
        'experience.fekra.b2': 'Refonte du processus de transfert de stock inter-agences, remplaçant l\'équilibrage manuel des stocks par un flux validé vérifiant la disponibilité avant transfert, réduisant le risque de rupture de stock et les délais de livraison',
        'experience.fekra.b3': 'Structuration du cycle client de la commande à l\'encaissement en étapes de cycle de vie gouvernées avec facturation automatisée, améliorant la traçabilité des commandes pour les équipes commerciales',
        'experience.fekra.b4': 'Mise en place de la gouvernance des données et de contrôles d\'accès basés sur les rôles pour les données de référence des stocks, éliminant les modifications non restreintes',
        'experience.fekra.b5': 'Extension du modèle de données d\'inventaire avec génération automatique d\'identifiants et une interface de gestion dédiée',
        'experience.fekra.b6': 'Application d\'une approche de continuité de livraison pour modifier des structures de base de données en production sans interruption d\'activité',
        'experience.fekra.b7': 'Livraison des 7 chantiers tout en préservant l\'architecture standard de l\'ERP, garantissant que la plateforme du client reste entièrement évolutive',
        'experience.yousfdent.title': 'Partenaire Transformation Digitale & Croissance Commerciale',
        'experience.yousfdent.meta': 'Avr 2026 – Présent · Rabat-Salé-Kénitra, Maroc · Hybride',
        'experience.yousfdent.b1': 'Digitalisation du modèle de vente traditionnel de produits dentaires de YousfDent via le développement et la gestion de sa plateforme e-commerce, de son système de stock et commandes, de sa génération de leads et de sa stratégie commerciale digitale.',
        'experience.yousfdent.b2': 'Contribution à la croissance de l\'activité et à l\'amélioration des performances commerciales grâce à une approche moderne d\'acquisition et de vente en ligne.',
        'experience.yousfdent.p1': 'YousfDent — identité de marque',
        'experience.yousfdent.p2': 'YousfDent — page d\'accueil',
        'experience.yousfdent.p3': 'Catalogue par catégories',
        'experience.yousfdent.p4': 'Catalogue produits',
        ...
        'certifications.ifsadvanced.title': 'IFS Learning Achievement - Advanced Web Development Concepts (IFS Cloud)',
        'certifications.ifsadvanced.provider': 'IFS',
        'certifications.ifsadvanced.date': 'Émis juin 2026',
        'certifications.ifsadvanced.mediaCaption': 'Certification IFS Advanced Web Development Concepts',
        'certifications.ifsux.title': 'IFS Learning - User Experience Fundamentals (IFS Cloud)',
        'certifications.ifsux.provider': 'IFS',
        'certifications.ifsux.date': 'Émis juin 2026',
        'certifications.ifsux.mediaCaption': 'Certification IFS User Experience Fundamentals',
        'certifications.bizstrategy.title': 'Foundations of Business Strategy',
        'certifications.bizstrategy.provider': 'University of Virginia',
        ...
        'certifications.honoris.mediaCaption': 'Certificat Honoris 21st Century Soft Skills',
        'certifications.springcloud.title': 'Advanced Spring Cloud Microservices & Deployment with Docker',
        'certifications.springcloud.provider': 'Packt',
        ...
        'extracurricular.fitwinz.b1': 'Création et développement de Fitwinz, marque marocaine de sportswear axée sur la performance, le confort et une approche plus saine du vêtement.',
        'extracurricular.fitwinz.b2': 'Pilotage du développement de la marque, incluant design produit, stratégie de branding et engagement client, avec un focus sur des matières naturelles comme la laine, le lin et le coton biologique.',
        'extracurricular.fitwinz.b3': 'Gestion des opérations business : étude de marché, stratégie de prix, planification des ventes et initiatives de marketing digital.',
        'extracurricular.fitwinz.p1': 'Site officiel Fitwinz',
        'extracurricular.fitwinz.p2': 'Compression Top 1 (tissu à base de lin)',
        'extracurricular.fitwinz.p3': 'Compression Top 2 (tissu à base de lin)',
        'extracurricular.fitwinz.p4': 'Coupe oversize 1 (tissu à base de laine)',
        'extracurricular.fitwinz.p5': 'T-shirt de compression (coton biologique)',
        'extracurricular.fitwinz.p7': 'Compression Top (tissu à base de lin)',
        'extracurricular.fitwinz.p8': 'Coupe oversize (tissu à base de laine)',
        'extracurricular.fitwinz.p6': 'Fabrication Fitwinz & collaboration produit',
    ...
    ar: {
        ...
        'experience.fekra.title': 'محلل العمليات التجارية',
        'experience.fekra.company': 'FEKRA Group · شركة استشارات تقنية معلومات دولية وتحول رقمي',
        'experience.fekra.meta': 'مشروع نهاية الدراسة (PFE) · مارس 2026 – أغسطس 2026 · الدار البيضاء، المغرب',
        'experience.fekra.summary': 'مشروع نهاية الدراسة يتناول تحليل وتحسين عمليات المبيعات وسلسلة التوريد لعميل توزيع متعدد العلامات التجارية، من خلال تقديم سبعة تحسينات تشغيلية على منصة IFS Cloud ERP.',
        'experience.fekra.b1': 'تحليل عمليات المبيعات وسلسلة التوريد لعميل توزيع متعدد العلامات التجارية؛ تحديد وترتيب أولويات 7 فجوات تشغيلية',
        'experience.fekra.b2': 'إعادة تصميم عملية نقل المخزون بين الفروع، واستبدال الموازنة اليدوية للمخزون بسير عمل معتمد يتحقق من التوفر قبل النقل، مما يقلل من مخاطر نفاد المخزون وتأخير التسليم',
        'experience.fekra.b3': 'هيكلة دورة الطلب إلى التحصيل للعملاء ضمن مراحل دورة حياة محكومة مع فوترة آلية، مما يحسن تتبع الطلبات لفرق المبيعات',
        'experience.fekra.b4': 'تطبيق حوكمة البيانات وضوابط الوصول القائمة على الأدوار على بيانات المخزون الأساسية، مما ألغى التعديلات غير المقيدة',
        'experience.fekra.b5': 'توسيع نموذج بيانات المخزون بإضافة توليد تلقائي للمعرفات وواجهة إدارة مخصصة',
        'experience.fekra.b6': 'تطبيق نهج استمرارية التسليم لتعديل هياكل قاعدة البيانات الحية دون أي انقطاع في العمل',
        'experience.fekra.b7': 'تسليم جميع مسارات العمل السبعة مع الحفاظ على البنية المعيارية لنظام ERP، مما يضمن بقاء منصة العميل قابلة للترقية بالكامل',
        'experience.yousfdent.title': 'شريك التحول الرقمي ونمو المبيعات',
        'experience.yousfdent.meta': 'أبريل 2026 – حتى الآن · الرباط-سلا-القنيطرة، المغرب · هجين',
        'experience.yousfdent.b1': 'رقمنة نموذج مبيعات منتجات الأسنان التقليدي لـ YousfDent عبر تطوير وإدارة منصة التجارة الإلكترونية، ونظام إدارة المخزون والطلبات، وعملية توليد العملاء المحتملين، والاستراتيجية الرقمية للمبيعات.',
        'experience.yousfdent.b2': 'المساهمة في توسيع النشاط وتحسين أداء المبيعات من خلال نهج حديث للاكتساب والبيع عبر الإنترنت.',
        'experience.yousfdent.p1': 'YousfDent — الهوية البصرية',
        'experience.yousfdent.p2': 'YousfDent — الصفحة الرئيسية',
        'experience.yousfdent.p3': 'دليل الفئات',
        'experience.yousfdent.p4': 'دليل المنتجات',
        ...
        'certifications.ifsadvanced.title': 'IFS Learning Achievement - Advanced Web Development Concepts (IFS Cloud)',
        'certifications.ifsadvanced.provider': 'IFS',
        'certifications.ifsadvanced.date': 'صدر يونيو 2026',
        'certifications.ifsadvanced.mediaCaption': 'شهادة IFS Advanced Web Development Concepts',
        'certifications.ifsux.title': 'IFS Learning - User Experience Fundamentals (IFS Cloud)',
        'certifications.ifsux.provider': 'IFS',
        'certifications.ifsux.date': 'صدر يونيو 2026',
        'certifications.ifsux.mediaCaption': 'شهادة IFS User Experience Fundamentals',
        'certifications.bizstrategy.title': 'Foundations of Business Strategy',
        'certifications.bizstrategy.provider': 'University of Virginia',
        ...
        'certifications.honoris.mediaCaption': 'شهادة Honoris 21st Century Soft Skills',
        'certifications.springcloud.title': 'Advanced Spring Cloud Microservices & Deployment with Docker',
        'certifications.springcloud.provider': 'Packt',
        ...
        'extracurricular.fitwinz.b1': 'تأسيس وتطوير Fitwinz كعلامة مغربية للملابس الرياضية تركز على الأداء والراحة ونهج أكثر صحة في اللباس.',
        'extracurricular.fitwinz.b2': 'قيادة تطوير العلامة بما يشمل تصميم المنتجات واستراتيجية الهوية والتفاعل مع العملاء، مع التركيز على المواد الطبيعية مثل الصوف والكتان والقطن العضوي.',
        'extracurricular.fitwinz.b3': 'إدارة العمليات التجارية بما في ذلك دراسة السوق واستراتيجية التسعير وتخطيط المبيعات ومبادرات التسويق الرقمي.',
        'extracurricular.fitwinz.p1': 'الموقع الرسمي لـ Fitwinz',
        'extracurricular.fitwinz.p2': 'قميص ضغط 1 (قماش أساسه الكتان)',
        'extracurricular.fitwinz.p3': 'قميص ضغط 2 (قماش أساسه الكتان)',
        'extracurricular.fitwinz.p4': 'قَصّة واسعة 1 (قماش أساسه الصوف)',
        'extracurricular.fitwinz.p5': 'قميص ضغط (قماش أساسه القطن العضوي)',
        'extracurricular.fitwinz.p7': 'قميص ضغط (قماش أساسه الكتان)',
        'extracurricular.fitwinz.p8': 'قَصّة واسعة (قماش أساسه الصوف)',
        'extracurricular.fitwinz.p6': 'تصنيع Fitwinz وتعاون تطوير المنتج',
    ...
    es: {
        ...
        'experience.fekra.title': 'Analista de Procesos de Negocio',
        'experience.fekra.company': 'FEKRA Group · Consultoría de TI Internacional y Transformación Digital',
        'experience.fekra.meta': 'Proyecto de Fin de Estudios (PFE) · Mar 2026 – Ago 2026 · Casablanca, Marruecos',
        'experience.fekra.summary': 'Proyecto de fin de estudios centrado en analizar y optimizar los procesos de ventas y cadena de suministro de un cliente de distribución multimarca, entregando siete mejoras operativas en la plataforma ERP IFS Cloud.',
        'experience.fekra.b1': 'Análisis de los procesos de ventas y cadena de suministro de un cliente de distribución multimarca; identificación y priorización de 7 brechas operativas',
        'experience.fekra.b2': 'Rediseño del proceso de transferencia de stock entre sucursales, sustituyendo el balanceo manual de inventario por un flujo validado que verifica la disponibilidad antes de la transferencia, reduciendo el riesgo de rotura de stock y los retrasos en la entrega',
        'experience.fekra.b3': 'Estructuración del ciclo de pedido a cobro del cliente en etapas de ciclo de vida gobernadas con facturación automatizada, mejorando la trazabilidad de los pedidos para los equipos comerciales',
        'experience.fekra.b4': 'Implementación de gobernanza de datos y controles de acceso basados en roles en los datos maestros de inventario, eliminando modificaciones sin restricciones',
        'experience.fekra.b5': 'Ampliación del modelo de datos de inventario con generación automática de identificadores y una interfaz de gestión dedicada',
        'experience.fekra.b6': 'Aplicación de un enfoque de continuidad de entrega para modificar estructuras de base de datos en producción sin interrupción del negocio',
        'experience.fekra.b7': 'Entrega de los 7 workstreams preservando la arquitectura estándar del ERP, manteniendo la plataforma del cliente totalmente actualizable',
        'experience.yousfdent.title': 'Socio de Transformación Digital y Crecimiento Comercial',
        'experience.yousfdent.meta': 'Abr 2026 – Presente · Rabat-Salé-Kénitra, Marruecos · Híbrido',
        'experience.yousfdent.b1': 'Digitalización del modelo tradicional de venta de productos dentales de YousfDent mediante el desarrollo y la gestión de su plataforma e-commerce, sistema de stock y pedidos, proceso de generación de leads y estrategia comercial digital.',
        'experience.yousfdent.b2': 'Contribución al crecimiento del negocio y a la mejora del rendimiento comercial mediante un enfoque moderno de adquisición y ventas online.',
        'experience.yousfdent.p1': 'YousfDent — identidad de marca',
        'experience.yousfdent.p2': 'YousfDent — página de inicio',
        'experience.yousfdent.p3': 'Catálogo por categorías',
        'experience.yousfdent.p4': 'Catálogo de productos',
        ...
        'certifications.ifsadvanced.title': 'IFS Learning Achievement - Advanced Web Development Concepts (IFS Cloud)',
        'certifications.ifsadvanced.provider': 'IFS',
        'certifications.ifsadvanced.date': 'Emitido jun 2026',
        'certifications.ifsadvanced.mediaCaption': 'Certificación IFS Advanced Web Development Concepts',
        'certifications.ifsux.title': 'IFS Learning - User Experience Fundamentals (IFS Cloud)',
        'certifications.ifsux.provider': 'IFS',
        'certifications.ifsux.date': 'Emitido jun 2026',
        'certifications.ifsux.mediaCaption': 'Certificación IFS User Experience Fundamentals',
        'certifications.bizstrategy.title': 'Foundations of Business Strategy',
        'certifications.bizstrategy.provider': 'University of Virginia',
        ...
        'certifications.honoris.mediaCaption': 'Certificado Honoris 21st Century Soft Skills',
        'certifications.springcloud.title': 'Advanced Spring Cloud Microservices & Deployment with Docker',
        'certifications.springcloud.provider': 'Packt',
        ...
        'extracurricular.fitwinz.b1': 'Fundé y desarrollé Fitwinz, una marca marroquí de ropa deportiva enfocada en rendimiento, comodidad y un enfoque más saludable de la vestimenta.',
        'extracurricular.fitwinz.b2': 'Lideré el desarrollo de marca, incluyendo diseño de producto, estrategia de branding y relación con clientes, con enfoque en materiales naturales como lana, lino y algodón orgánico.',
        'extracurricular.fitwinz.b3': 'Gestioné operaciones del negocio, incluyendo investigación de mercado, estrategia de precios, planificación de ventas e iniciativas de marketing digital.',
        'extracurricular.fitwinz.p1': 'Sitio web oficial de Fitwinz',
        'extracurricular.fitwinz.p2': 'Top de compresión 1 (tejido a base de lino)',
        'extracurricular.fitwinz.p3': 'Top de compresión 2 (tejido a base de lino)',
        'extracurricular.fitwinz.p4': 'Corte oversize 1 (tejido a base de lana)',
        'extracurricular.fitwinz.p5': 'Camiseta de compresión (algodón orgánico)',
        'extracurricular.fitwinz.p7': 'Top de compresión (tejido a base de lino)',
        'extracurricular.fitwinz.p8': 'Corte oversize (tejido a base de lana)',
        'extracurricular.fitwinz.p6': 'Fabricación Fitwinz y colaboración de producto',
